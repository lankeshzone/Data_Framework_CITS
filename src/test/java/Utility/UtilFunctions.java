package Utility;
	...
	public class UtilFunctions {
	    ...
	    public static void setRESULTPHAT() {

	        //RESULTPHAT = "\\results\\" + System.getenv().get("COMPUTERNAME") + "\\" + getDATETIME();
	        RESULTPHAT = ProjectConstants.RESULT_DIRECTORY + "\\" + getDATETIME();
	    ...
	    public static void UpdateWEBFile(String FileName, String imageFolderName) {
	        try {
	            ...
	            // "file:///D:\muullah\EntertainTV\WebClientReport\"
	        } catch (Exception e) {
	            //fail to create directory
	            e.printStackTrace();
	        }
	    ...
	    private static Properties getProperties(String aFile) throws IOException {
	        ...
	        Logger.out(5, "Proprties file: " + aFile);
